const CACHE = 'redvecinal-v1';
const STATIC = ['./public/assets/css/bootstrap.min.css','./public/assets/css/app.css','./public/assets/js/bootstrap.bundle.min.js','./public/assets/js/app.js','./public/assets/img/icon.svg','./','./ingresar'];
