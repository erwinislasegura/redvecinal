const CACHE = 'redvecinal-v7';
const STATIC = ['./public/assets/css/bootstrap.min.css','./public/assets/css/app.css','./public/assets/css/admin.css','./public/assets/css/admin-modules.css','./public/assets/js/bootstrap.bundle.min.js','./public/assets/js/app.js','./public/assets/img/icon.svg','./public/assets/img/icon-192.png','./public/assets/img/icon-512.png','./','./ingresar'];
