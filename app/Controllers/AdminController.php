...
final class AdminController extends Controller
{
    ...
    public function settings(): void
    {
        ...
        $defaults=['organization_name'=>'RedVecinal','municipal_phone'=>'','municipal_email'=>'','municipal_address'=>'','reports_anonymous'=>'1','notifications_enabled'=>'1','device_alerts_enabled'=>'1','map_center_lat'=>'-37.4689','map_center_lng'=>'-72.3527','report_retention_days'=>'365'];
    ...
    public function updateSettings(): void
    {
        ...
        $allowed=['organization_name','municipal_phone','municipal_email','municipal_address','map_center_lat','map_center_lng','report_retention_days'];$new=[];
