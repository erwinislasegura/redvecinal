...
El seguimiento GPS de emergencias crea automáticamente sus tablas la primera vez que se utiliza. Si el usuario MySQL no tiene permiso `CREATE`, importa manualmente `database/updates/2026_08_16_panic_tracking.sql` desde phpMyAdmin. Esta actualización no modifica ni elimina datos existentes.
